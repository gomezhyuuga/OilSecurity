...
GRANT EXECUTE ON ROUTINE `oilsec`.* TO 'oiluser';
GRANT SELECT ON TABLE `oilsec`.* TO 'oiluser';
GRANT SELECT, INSERT, TRIGGER ON TABLE `oilsec`.* TO 'oiluser';
GRANT SELECT, INSERT, TRIGGER, UPDATE, DELETE ON TABLE `oilsec`.* TO 'oiluser';
