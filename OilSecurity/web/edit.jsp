<%-- 
    Document   : edit
    Created on : Oct 23, 2015, 11:37:12 AM
    Author     : gomezhyuuga
--%>
...
<html lang="en">
    <head>
        ...
        <title>Petromex - Modificar Inventario</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="blog-header">
                <h1>Modificar inventario actual</h1>
            </div>

            <div class="row">
                <div class="col-sm-11 blog-main">
                    <div class="blog-post">
                        <p>Llene el formulario que se presenta a continuación con las modificaciones que requiere hacer.</p>
                        <hr>
